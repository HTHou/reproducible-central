...
| -- | --------- | ------ | -- |
| [1.4.0](https://central.sonatype.com/artifact/de.unentscheidbar/migratedb/1.4.0/pom) | [mvn jdk11](migratedb-1.4.0.buildspec) | [result](migratedb-1.4.0.buildinfo): [8 :white_check_mark:  6 :warning:](migratedb-1.4.0.buildcompare) | 801K |
